...
export function TemplatePicker({ templates }: TemplatePickerProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="fixed inset-x-0 bottom-[calc(4.5rem+env(safe-area-inset-bottom,0px))] z-40 border-t border-white/10 bg-[#090511]/94 px-3 py-2 shadow-[0_-16px_34px_rgba(0,0,0,0.34)] backdrop-blur-xl lg:hidden"
        data-testid="template-mobile-cta"
      >
