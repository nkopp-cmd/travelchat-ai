            ...
            if (city) {
                ...
                try {
                    ...
                    if (persistResult) {
                        ...
                        if (persistResult.slides) {
                            setSlides(prev => prev.map(slide => {
                                const key = slide.type === "day" ? `day${slide.day}` : slide.type;
                                const cdnUrl = persistResult.slides[key];
    ...
    return (
        ...
        <Dialog open={open} onOpenChange={(nextOpen) => {
            ...
            <DialogContent showCloseButton={false} className="sm:max-w-2xl max-h-[90vh] overflow-y-auto flex flex-col">
                ...
                <Tabs value={format} onValueChange={value => {
                    ...
                    <TabsList aria-label="Story format" className="h-11 w-full">
                        ...
                        <TabsTrigger value="video" disabled={isGenerating || isSavingToCloud || downloadingIndex !== null}>Video</TabsTrigger>
                    </TabsList>
