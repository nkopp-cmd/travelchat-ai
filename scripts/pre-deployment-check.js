...
check('Better Auth installed', !!deps['better-auth']);
...
if (fileExists('.env.local')) {
  ...
  check('BETTER_AUTH_SECRET configured', hasEnvValue(env, 'BETTER_AUTH_SECRET'));
  check('RESEND_API_KEY configured (auth email)', hasEnvValue(env, 'RESEND_API_KEY'));
