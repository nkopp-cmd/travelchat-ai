...
Native creation, catalog-backed generate, owner-only duplication, and owner-only share links are in this shell. Paid AI generation, media, billing, and complete server-page routing remain unfinished.
