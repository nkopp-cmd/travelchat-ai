...
The remaining code integration follows `releases/story-studio-merge.md`.
That contract supersedes earlier missing-access and unapplied-image-ledger notes in this historical report.
It does not authorize activating new paid generation or migrating hosting.
