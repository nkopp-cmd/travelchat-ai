  ...
  return (
    <AppBackground ambient className="min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground transition-colors mb-5"
        >
        ...
        <div className="space-y-10">
          ...
          {paceGroups.relaxed.length > 0 && (
            <section className="relative">
              ...
              <div className="flex items-center gap-3 mb-4 rounded-lg border border-black/5 bg-white/50 p-3 backdrop-blur-sm dark:border-white/10 dark:bg-white/5">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-100 to-teal-100 text-xl dark:from-emerald-900/30 dark:to-teal-900/30">
                  🌊
                </div>
                <div className="min-w-0">
                  <h2 className="text-xl font-bold">Relaxed Pace</h2>
                  <p className="text-muted-foreground text-sm">
                    Take it easy with leisurely itineraries perfect for unwinding
                  </p>
                </div>
                <Badge className="ml-auto shrink-0 bg-emerald-100/80 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-200/50 dark:border-emerald-700/30">
          ...
          {paceGroups.moderate.length > 0 && (
            <section className="relative">
              ...
              <div className="flex items-center gap-3 mb-4 rounded-lg border border-black/5 bg-white/50 p-3 backdrop-blur-sm dark:border-white/10 dark:bg-white/5">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 text-xl dark:from-blue-900/30 dark:to-indigo-900/30">
                  🚶
                </div>
                <div className="min-w-0">
                  <h2 className="text-xl font-bold">Moderate Pace</h2>
                  <p className="text-muted-foreground text-sm">
                    Balanced itineraries with a mix of activities and downtime
                  </p>
                </div>
                <Badge className="ml-auto shrink-0 bg-blue-100/80 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 border border-blue-200/50 dark:border-blue-700/30">
          ...
          {paceGroups.active.length > 0 && (
            <section className="relative">
              ...
              <div className="flex items-center gap-3 mb-4 rounded-lg border border-black/5 bg-white/50 p-3 backdrop-blur-sm dark:border-white/10 dark:bg-white/5">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-orange-100 to-red-100 text-xl dark:from-orange-900/30 dark:to-red-900/30">
                  ⚡
                </div>
                <div className="min-w-0">
                  <h2 className="text-xl font-bold">Active Pace</h2>
                  <p className="text-muted-foreground text-sm">
                    Packed itineraries for travelers who want to see and do it all
                  </p>
                </div>
                <Badge className="ml-auto shrink-0 bg-orange-100/80 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400 border border-orange-200/50 dark:border-orange-700/30">
